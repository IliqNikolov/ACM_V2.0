...
namespace ACM
{
    public static class MagicStrings
    {
        ...
        public static string DBConnectionString = @"Data Source=tcp:tostersql.database.windows.net,1433;Initial Catalog=tosterSQL;User Id=toster92@tostersql.database.windows.net;Password=Toster911;";
